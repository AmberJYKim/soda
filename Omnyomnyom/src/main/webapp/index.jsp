...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/style.css" />
 <!-- 로그인 메뉴 -->
    ...
    <!-- js/main.js에 로그인 메뉴를 위한 코드 추가 했으나 주석처리함 -->
    <div class="infor-model-warp">
        <div class="infor-model d-flex align-items-center">
            ...
            <div class="login infor-middle wrap-login100">
                <!-- 홈페이지 로고(링크 기능 있는듯) -->
                <a href="#" class="login infor-logo">
                    <img class="login" src="${pageContext.request.contextPath }/resources/images/onn_logo_red.png" alt="">
                </a>


                <form class="login login100-form validate-form">
                    <!-- 아이디 입력 -->
                    <div class="login wrap-input100 validate-input">
                        <input class="login input100" type="text" name="username" placeholder="아이디">
                        <span class="login focus-input100"></span>
                    </div>

                    <!-- 비밀번호 입력 -->
                    <div class="login wrap-input100 validate-input">
                        <input class="login input100" type="password" name="pass" placeholder="비밀번호">
                        <span class="login focus-input100"></span>
                    </div>

                    <!-- 비밀번호 찾기 링크 -->
                    <div class="login  p-t-8 p-b-31">
                        <a class="login" href="#">
							비밀번호 찾기
						</a>
                    </div>
                    ...
                    <div class="container-login100-form-btn login">
                        <div class="wrap-login100-form-btn login">
                    ...
                    <div class="login txt1 text-center p-t-54 p-b-20">
                        <span class="login">
							다른 사이트 로그인
						</span>
                    </div>
                    ...
                    <!-- 다른 사이트 이이디 로그인 아이콘들 -->
                    <div class="login flex-c-m">
                        <!-- 네이버 -->
                        <a href="#" class="login login100-social-item bg1">
                            <img src="${pageContext.request.contextPath }/resources/images/ui/naver_icon.png" alt="">
                        </a>
                        <!-- 카카오 -->
                        <a href="#" class="login login100-social-item bg2">
                            <img src="${pageContext.request.contextPath }/resources/images/ui/kakao_icon.png" alt="">
                        </a>
                        <!-- 구글 -->
                        <a href="#" class="login login100-social-item">
                            <img src="${pageContext.request.contextPath }/resources/images/ui/google_icon.png" alt="">
                        </a>
                        <!-- 페이스북 -->
                        <a href="#" class="login login100-social-item bg3">
                            <img src="${pageContext.request.contextPath }/resources/images/ui/facebook_icon.png" alt="">
                        </a>
                    </div>
                </form>
            </div>
