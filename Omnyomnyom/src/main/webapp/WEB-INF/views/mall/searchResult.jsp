...
<!--------------------------------재료가 추가되는 영역 ------------------------------>
                        ...
                        <c:forEach items="${list }" var="ingMall"> 
							<div class="col-lg-2 row product_container">
	                            <a href="${pageContext.request.contextPath}/mall/productDetail?ingMallNo=${ingMall.ingMallNo}"><img src="${pageContext.request.contextPath }/resources/images/ingredient/${ingMall.mallEngPrCategory}/${ingMall.mallEngCdCategory}/${ingMall.prevImg}" alt="" class="col-12 border-rai"></a>
	                            <div class="col">
