			...
			<div class="row">
				<div class="col-lg-7">
					...
					<div class="oneday_class_img">
						...
						<input type='file' id="imgInput" hidden /> <img src="#" alt=""
							id="image_section">
					</div>
				...
				<div class="col-lg-5 col-md-5 col-sm-8 sidebar">
					<div class="sb-widget">
						<div class="classes-info">
							<!-- 클래스 명 입력란 -->
							<span class="input input--yoshiko"> <!-- 클래스명 input --> <input
								class="input__field input__field--yoshiko" type="text"
								id="input-class-name" /> <!-- 클래스명 라벨 --> <label
								class="input__label input__label--yoshiko"
								for="input-class-name"> <span
									class="input__label-content input__label-content--yoshiko"
									data-content="클래스명">클래스명</span>
							</label>
							</span>

							<!-- 셰프 채널명 입력란 -->
							<span class="input input--yoshiko"> <!-- 셰프 채널명 input(readonly) -->
								<input class="input__field input__field--yoshiko" type="text"
								id="input-class-channel" value="셰프채널명" readonly/> <!-- 셰프 채널명 라벨 -->
								<label class="input__label input__label--yoshiko"
								for="input-class-channel"> <span
									class="input__label-content input__label-content--yoshiko"
									data-content="채널명">채널명</span>
							</label>
							</span>
							<!-- 클래스 비용 입력란 -->
							<span class="input input--yoshiko"> <!-- 클래스 비용 input -->
								<input class="input__field input__field--yoshiko" type="text"
								id="input-class-cost" /> <!-- 클래스 비용 라벨 --> <label
								class="input__label input__label--yoshiko"
								for="input-class-cost"> <span
									class="input__label-content input__label-content--yoshiko"
									data-content="클래스 비용">클래스 비용</span>
							</label>
							</span>
							...
							<div class="row m-auto">
								...
								<span class="input input--yoshiko col px-1"> <!-- 시간 input -->
									...
									id="input-class-time-h" min="0" autocomplete="off" /> <!-- 시간 라벨 -->
									<label class="input__label input__label--yoshiko"
									for="input-class-time-h"> <span
										class="input__label-content input__label-content--yoshiko"
										data-content="시간">시간</span>
								</label>
								</span>
								<!-- 분 입력란 -->
								<span class="input input--yoshiko col pr-0"> <!-- 분 input -->
									<input class="input__field input__field--yoshiko" type="number"
									id="input-class-time-m" min="0" max="59" autocomplete="off" />
									<!-- 분 라벨 --> <label class="input__label input__label--yoshiko"
									for="input-class-time-m"> <span
										class="input__label-content input__label-content--yoshiko"
										data-content="분">분</span>
								</label>
								</span>
							</div>
							<!-- 클래스 소요시간 입력란 end -->
							...
							<div class="row">
								<!-- 정원 인원 입력란 -->
								<span class="input input--yoshiko col"> <!-- 정원 인원 input -->
									<input class="input__field input__field--yoshiko" type="number"
									id="input-class-max" min="0" max="100" autocomplete="off" /> <!-- 정원 인원 라벨 -->
									<label class="input__label input__label--yoshiko"
									for="input-class-max"> <span
										class="input__label-content input__label-content--yoshiko"
										data-content="정원 인원">정원 인원</span>
								</label>
								</span>
								<!-- 최소 인원 입력란 -->
								<span class="input input--yoshiko col"> <!-- 최소 인원 input -->
									<input class="input__field input__field--yoshiko" type="number"
									id="input-class-min" min="0" max="100" autocomplete="off" /> <!-- 최소 인원 라벨 -->
									<label class="input__label input__label--yoshiko"
									for="input-class-min"> <span
										class="input__label-content input__label-content--yoshiko"
										data-content="최소 인원">최소 인원</span>
								</label>
								</span>
							</div>
							<!-- 클래스 주소 입력란 -->
							<span class="input input--yoshiko"> <!-- 클래스 주소 input -->
								<input class="input__field input__field--yoshiko" type="text"
								id="input-class-adress" /> <!-- 클래스 주소 라벨 --> <label
								class="input__label input__label--yoshiko"
							...
							<div class="row m-auto">
								<span class="input input--yoshiko col-9 p-0"> <!-- 클래스 날짜 input -->
									...
									type="text" id="input-date" data-language='kr'
					...
					<div class="sb-widget">
						<!-- 클래스 등록 버튼 -->
						<button class="site-btn sb-gradient reservation_class">
							<a href="class_reservation.html">등록하기</a>
						</button>
					</div>
				</div>
			</div>
