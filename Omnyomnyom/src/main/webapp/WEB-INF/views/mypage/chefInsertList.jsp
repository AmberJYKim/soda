		...
		<div class="section">
			<div class="row">
				<div class="col side_nav">
					...
					<a href="${pageContext.request.contextPath}/mypage/chefInsertList"><p class="nav_text selected_nav">셰프신청목록</p></a>
					<a href="${pageContext.request.contextPath}/mypage/sendDingdong"><p class="nav_text">알림보내기</p></a>
				</div>
				<div class="col-10">
